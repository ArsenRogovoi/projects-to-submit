export const CreateTaskElement = (task) => {
    ...
    editBtn.classList.add("col-2", "p-0", "btn", "border", "border-dark", "border-1", "rounded", "m-1", "text-center", "bg-warning");
    const editBtnIcon = document.createElement("i");
    editBtnIcon.classList.add("bi", "bi-pencil");
    editBtnIcon.style.color = "black";
    editBtn.appendChild(editBtnIcon);
    const deleteBtn = document.createElement("div");
    deleteBtn.classList.add("col-2", "p-0", "btn", "border", "border-dark", "border-1", "rounded", "m-1", "text-center", "bg-danger");
    const deleteBtnIcon = document.createElement("i");
    deleteBtnIcon.classList.add("bi", "bi-trash3");
    deleteBtnIcon.style.color = "black";
    deleteBtn.appendChild(deleteBtnIcon);
    const doneBtn = document.createElement("div");
    doneBtn.classList.add("col-2", "p-0", "btn", "border", "border-dark", "border-1", "rounded", "m-1", "text-center", "bg-success");
