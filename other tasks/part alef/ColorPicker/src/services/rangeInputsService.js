import { INPUT_BADGE_BLUE, INPUT_BADGE_GREEN, INPUT_BADGE_RED, RESULT_COLORED_RECT, RESULT_HEX_CODE_BLUE, RESULT_HEX_CODE_GREEN, RESULT_HEX_CODE_RED, RESULT_RGB_CODE_BLUE, RESULT_RGB_CODE_GREEN, RESULT_RGB_CODE_RED, } from "./domService.js";
export const reactOnRangeInputs = (r, g, b) => {
