import { ARROW_BTN, CITIES_INPUT } from "./services/domService.js";
import { arrowBtnFunc, findMatchingCities, } from "./services/dropDownService.js";
export const cities = [
    {
        city: "Jerusalem",
        lat: "31.7833",
...
export const stringCities = cities.map((cityObj) => {
    return cityObj.city;
});
CITIES_INPUT.addEventListener("input", findMatchingCities);
ARROW_BTN.addEventListener("click", arrowBtnFunc);
