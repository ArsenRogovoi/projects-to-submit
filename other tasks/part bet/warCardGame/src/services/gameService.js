...
import { DEALER_DECK, DEALER_DECK_AMOUNT_CARDS, DEALER_INSTRUCTION_CONTAINER, PLAYER_1_CARD_CONTAINER, PLAYER_1_CARD_NUM, PLAYER_1_CARD_SUIT_DOWN, PLAYER_1_CARD_SUIT_TOP, PLAYER_1_CARD_VALUE_DOWN, PLAYER_1_CARD_VALUE_TOP, PLAYER_1_DECK, PLAYER_1_DECK_AMOUNT_CARDS, PLAYER_1_DRAW_BTN, PLAYER_1_NAME, PLAYER_2_CARD_CONTAINER, PLAYER_2_CARD_NUM, PLAYER_2_CARD_SUIT_DOWN, PLAYER_2_CARD_SUIT_TOP, PLAYER_2_CARD_VALUE_DOWN, PLAYER_2_CARD_VALUE_TOP, PLAYER_2_DECK, PLAYER_2_DECK_AMOUNT_CARDS, PLAYER_2_DRAW_BTN, PLAYER_2_NAME, START_GAME_BTN, } from "./domService.js";
...
export const turnOfPlayer1 = () => {
    if (specialTurn.isSpecialTurn) {
        if (gameDecks.dealerDeck.hasCard()) {
            if (specialTurn.numOfSpecialTurn === 2 ||
...
const renderDrawnedCard = (p, toShow) => {
...
const doWeHaveWinner = () => {
    if ((gameDecks.player1Deck?.hasCard() && gameDecks.player2Deck?.hasCard()) ||
...
const renderSymbolOfValue = (value) => {
    switch (value) {
        case 1:
            return "A";
        case 11:
